...
import io.confluent.developer.sql.usecases.AirlineDelayAnalytics;
import io.confluent.developer.sql.usecases.FlightRouteAnalytics;
import io.confluent.developer.sql.usecases.FlightStatusDashboard;
...
public class FlinkSqlMain {
    ...
    private static void printUsage() {
        LOG.info("Usage: FlinkSqlMain <use-case> [environment] [topic]");
